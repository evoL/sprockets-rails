...
class SprocketsTest < ActiveSupport::TestCase
  test "source files encryption" do
    ...
    assert_equal ERB::Util.h(Base64.encode64(source_files.to_json)), SprocketsApplication.encode(source_files)
  end

  test "source files decryption" do
    source_files = ["application.js", "source.js"]
    assert_equal source_files, SprocketsApplication.decode(SprocketsApplication.encode(source_files))
  end

  test "filtering source files by presence in app/javascripts" do
    source_files = ["application.js", "source.js", "../config/database.yml"]
    sprocket = Sprocket.new( SprocketsApplication.encode(source_files) )
